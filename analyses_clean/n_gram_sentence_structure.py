...
if __name__ == "__main__":
    ...
    default_output = project_root / "data/plots/_local/n_gram_sentence_structure"
    ...
    # Note: input/output paths can be overridden via ANALYSIS_INPUT_FILE / ANALYSIS_OUTPUT_DIR.
