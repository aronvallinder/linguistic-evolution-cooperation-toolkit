...
Use the unified script to run all analyses for a specific simulation JSON:

```bash
# Run everything on a single saved simulation
./scripts/run_all_analyses.sh -all data/json/main_loop/task_order/game_myth.json data/plots/task_order/game_myth

# Or run a subset
./scripts/run_all_analyses.sh -a cooperativity,trajectory,ngram data/json/main_loop/task_order/game_myth.json data/plots/task_order/game_myth
```

**Input**: Any saved simulation JSON (e.g. `data/json/main_loop/task_order/game_myth.json`)
**Output**: Any directory you choose (e.g. `data/plots/task_order/game_myth/`)
